function LoadingState() {
  return (
    <section className="relative z-10 flex min-h-screen w-full flex-col items-center justify-center overflow-hidden px-5 py-12 text-center">
      ...
      {/* Ambient glow */}
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-130 w-130 -translate-x-1/2 -translate-y-1/2 rounded-full bg-purple-600/8 blur-[120px]" />
      ...
      <div className="relative mb-10 flex h-32 w-32 items-center justify-center">
        ...
        {/* Core */}
        <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-linear-to-br from-violet-400 via-purple-600 to-fuchsia-700 shadow-[0_0_30px_rgba(139,92,246,0.45),0_0_80px_rgba(139,92,246,0.18)] animate-[pulse_2.2s_ease-in-out_infinite]">

          <span className="translate-x-0.5 text-2xl text-white">
            ▶
          </span>
      ...
      <div className="mt-9 w-full max-w-md">
        ...
        <div className="h-0.75 overflow-hidden rounded-full bg-white/[0.07]">
          ...
          <div className="h-full w-[78%] rounded-full bg-linear-to-r from-purple-500 via-violet-400 to-fuchsia-400 shadow-[0_0_14px_rgba(139,92,246,0.65)] animate-[loadingProgress_2.5s_ease-in-out_infinite]" />
      ...
      <div className="mt-8 flex w-full max-w-lg flex-col gap-3 text-left">
        ...
        <div className="flex items-center gap-4 rounded-2xl border border-white/[0.07] bg-white/2.5 px-4 py-4 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-4 rounded-2xl border border-purple-400/20 bg-purple-500/5 px-4 py-4 shadow-lg shadow-purple-900/8 backdrop-blur-xl">
